...
echo_and_run cd "/home/kathan/catkin_ws/src/robotiq-noetic-devel/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/kathan/catkin_ws/src/robotiq-noetic-devel/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/kathan/catkin_ws/build/robotiq-noetic-devel/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
